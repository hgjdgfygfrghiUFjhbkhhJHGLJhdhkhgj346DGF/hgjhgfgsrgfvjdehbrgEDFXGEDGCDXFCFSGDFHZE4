...
python3 src/scripts/extract_text.py results/sample/sample.pdf results/sample/sample.mmd
python3 src/scripts/extract_formulas.py results/sample/sample.mmd results/sample/sample.csv
